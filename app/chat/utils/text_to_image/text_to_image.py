...
class TextToImageGenerator:
    def __init__(self, stability_api_key=None, replicate_api_key=None):
        self.stability_api_key = stability_api_key or current_app.config["STABILITY_API_KEY"]
        self.replicate_api_key = replicate_api_key or current_app.config["REPLICATE_API_KEY"]
    ...
    def generate_image_from_text_stability(self, prompt, user_id, size="medium", samples=1):
        """
        ...
        try:
            ...
            chat_logger.error("An error occurred:")
    ...
    def generate_image_link(self, image, user_id):
        try:
            ...
            create_cloudwatch_rule(image_object_key, "plantid-chatbot-image-remover", delay_minutes=10080)
            return image_file_url
